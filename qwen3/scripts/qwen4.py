...
TRANSCRIPT_PATH = "/workspace/llm-tests/transcripts/jacob.json"
TEMPLATE_PATH = "/workspace/llm-tests/doctor-template.json"
PROMPT_PATH = "/workspace/llm-tests/prompt.txt"
OUTPUT_PATH = "/workspace/llm-tests/qwen3/Output/jacob-output.json"
...
print(f" Tokenization time: {tokenize_end - tokenize_start:.2f}s")
